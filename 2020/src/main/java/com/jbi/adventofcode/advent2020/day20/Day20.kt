package com.jbi.adventofcode.advent2020.day20
 ...
 */
object Day20 : DailySolution2020() {
    ...
    override fun part2(reader: BufferedReader): Any {
        ...
        val trueSizeOfTile = image[0][0]!!.data.size - 2 // removing border
        val trueImage: Array<IntArray> =
