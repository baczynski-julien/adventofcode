package com.jbi.adventofcode.advent2020.day4
...
object Day4 : DailySolution2020() {
    ...
    private val validationMap = mutableMapOf<String, Pair<Int,(String) -> Boolean>>().apply {
        put("byr", Pair(0x00000001, Day4::validateBYR))
        put("iyr", Pair(0x00000010, Day4::validateIYR))
        put("eyr", Pair(0x00000100, Day4::validateEYR))
        put("hgt", Pair(0x00001000, Day4::validateHGT))
        put("hcl", Pair(0x00010000, Day4::validateHCL))
        put("ecl", Pair(0x00100000, Day4::validateECL))
        put("pid", Pair(0x01000000, Day4::validatePID))
        put("cid", Pair(0x10000000, Day4::validateCID))
    }.toMap()
