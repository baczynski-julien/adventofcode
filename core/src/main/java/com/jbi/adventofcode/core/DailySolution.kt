package com.jbi.adventofcode.core
...
abstract class DailySolution {
    ...
    private val sampleFile: String
        get() = "$year/${this::class.java.simpleName.lowercase()}_sample.txt"
    private val inputFile: String
        get() = "$year/${this::class.java.simpleName.lowercase()}_input.txt"

    protected abstract val expectedResultP1: Any
    protected abstract val expectedResultP2: Any

    private val TAG: String
        get() = this::class.java.simpleName.uppercase()
